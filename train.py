...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet101_fpn_backbone(pretrain_path="", trainable_layers=3)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--wd', '--weight-decay', default=1e-4, type=float,
                        ...
                        dest='weight_decay')
    # 针对torch.optim.lr_scheduler.MultiStepLR的参数, 衰减学习率
    parser.add_argument('--lr-steps', default=[3, 6, 9, 12], nargs='+', type=int,
